...
- Any binary file, if using force mode*...
...
Here is a *non-exhaustive* list of programs/videogames that have been verified to work and can be modified using strindex (without resorting to "force mode"):
